    ...
    <li class="review__list">
      ...
      <div class="review__list-product">
        ...
        <div class="review__list-product-content">
          ...
          <template
            class="review__list-product-img"
            v-if="result.imageUrls && result.imageUrls.length > 0"
          >
            <img
      ...
      <div class="review__list-changes">
        <div class="review__list-changes-published">
          <span>
            ...
            <span
              :class="{
                'green-text': result.published,
                'red-text': !result.published,
              }"
            >
        ...
        <button class="all-around-btn">Make Changes</button>
      </div>
    </li>
  </div>
</template>
